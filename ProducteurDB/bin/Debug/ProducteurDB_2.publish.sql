...
AS
	...
	INSERT INTO [Customer]([Lastname], [Firstname], [Email], [Password], [Presalt], [Postsalt], [Address],[isAdmin])
	OUTPUT [Inserted].[Id]
	VALUES (@LastName,@FirstName,@Email,@PwdHased,@Presalt, @Postsalt, @Address, @isAdmin)
GO
...
AS
	BEGIN
		INSERT INTO [Product]([Name],[Quantite],[ProducteurID],[Description])
		Values (@nom, @quantite, @ProducteurId, @Description)
		RETURN 0
	END
GO
PRINT N'Création de Procédure [dbo].[CreateProductor]...';


GO
CREATE PROCEDURE [dbo].[CreateProductor]
	@LastName NVARCHAR(50),
	@FirstName NVARCHAR(50),
	@Email NVARCHAR(384),
	@Password NVARCHAR(50),
...
AS
	...
	DECLARE @PwdHased as BINARY(64)
	SET @PwdHased=[dbo].[Hash]([dbo].[Salt](@Presalt,@Password,@Postsalt))
	INSERT INTO [Producer]([Lastname], [Firstname], [Email], [Password], [Presalt], [Postsalt], [Address])
	OUTPUT [Inserted].[Id]
	VALUES (@LastName,@FirstName,@Email,@PwdHased,@Presalt, @Postsalt, @Address)
GO
...
As
	BEGIN
		INSERT INTO [Purchase]([Date],[CustomerID],[ProductID])
		VALUES (@Date,@CustomerId,@ProductId)
		RETURN 0
	END
GO
...
AS
	BEGIN
		SELECT [Id],[Lastname],[Firstname],[Address],[Email],'******' as [Password], [isAdmin] FROM [Customer]
		WHERE [Id]=@id
		RETURN 0
	END
GO
...
AS
	BEGIN
		SELECT [Id],[Lastname],[Firstname],[Address],[Email],'******' as [Password] FROM [Producer]
		WHERE [Id]=@id
		RETURN 0
	END
GO
