...
CREATE PROCEDURE [dbo].[CreateAdress]
	...
	@Pays NVARCHAR(50)
AS
	INSERT INTO[Address]([Rue],[Numero],[Codepostal],[Ville],[Pays])
	OUTPUT [inserted].Id
	Values (@Rue, @Numero, @Ville, @Codepostal, @Pays)
RETURN 0
GO
...
AS	
	...
	INSERT INTO [Address]([Rue], [Numero], [Ville], [Codepostal], [Pays])
	OUTPUT [inserted].Id
	VALUES (@Rue,@Numero, @Ville,@Codepostal, @Pays)
	
	SET @AddressId= (SELECT ID FROM [Address] 
						WHERE [Rue]=@rue 
						AND [Numero]=@numero
						AND [Ville]=@Ville 
